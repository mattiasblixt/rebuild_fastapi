...
class TestSum(unittest.TestCase):
    ...
    def test_two_five_one_keys(self):
        """
        test two top dicts 5 sub dicts one bottom dict
        """
        data = 'cre:{ubuntu:{noble:check-mk-raw-2.3.0p6_0.noble_amd64.deb},debian:{bookworm:check-mk-raw-2.3.0p6_0.bookworm_amd64.deb},sles:{sles15sp5:check-mk-raw-2.3.0p6-sles15sp5-38.x86_64.rpm},redhat:{el9:check-mk-raw-2.3.0p6-el9-38.x86_64.rpm},docker:{docker:check-mk-raw-docker-2.3.0p6.tar.gz}},cee:{ubuntu:{noble:check-mk-enterprise-2.3.0p6_0.noble_amd64.deb},debian:{bookworm:check-mk-enterprise-2.3.0p6_0.bookworm_amd64.deb},sles:{sles15sp5:check-mk-enterprise-2.3.0p6-sles15sp5-38.x86_64.rpm},redhat:{el9:check-mk-enterprise-2.3.0p6-el9-38.x86_64.rpm},docker:{docker:check-mk-enterprise-docker-2.3.0p6.tar.gz},cma:{cma-3:check-mk-enterprise-2.3.0p6-3-x86_64.cma}},'
        computation = str_to_dict(data)
        expected = {'cre':{'ubuntu':{
